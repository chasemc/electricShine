...
To modify the example: Replace the two `app_ui` with your package's `app_ui` function name. Replace the two `app_server` with your package's `app_server` function name. 
