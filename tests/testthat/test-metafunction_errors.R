...
#                fixed = TRUE)
#   expect_error(fail3(),
#                "electricShine::electrify() requires you to provide an 'app_name' argument specifying\n         the shiny app/package name.",
#                fixed = TRUE)
#   expect_error(fail4(),
#                "electricShine::electrify() requires you to specify a 'semantic_version' argument.\n           (e.g. electricShine::electricShine(semantic_version = '1.0.0') )",
#                fixed = TRUE)
#   expect_error(fail5(),
#                "electricShine::electrify() requires you to specify a 'function_name' argument.\n         function_name should be the name of the function that starts your package's shiny app.\n         e.g. is you have the function myPackage::start_shiny(), provide 'start_shiny'",
#                fixed = TRUE)
#   expect_error(fail6(),
#                "electricShine::electrify() requires you to specify a 'package_name' argument.\n           (e.g. electricShine::electricShine(package_name = 'myPackage') )",
#                fixed = TRUE)
# })
# 
# 
