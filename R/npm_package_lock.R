...
#' Create package-lock.json for npm
#'
#' @param path path to write package-lock.json for npm
#'
#' @return nothing, writes package-lock.json to path provided and provides feedback if succcessful or not
#' @export
#'
create_package_lock_json <- function(path){
...
'{
  ...
  "dependencies": {
    ...
    "electron": {
      "version": "4.0.3",
      "resolved": "https://registry.npmjs.org/electron/-/electron-4.0.3.tgz",
